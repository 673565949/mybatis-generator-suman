...
public class ServiceInterfaceGenerator extends AbstractJavaClientGenerator {
    ...
    public ServiceInterfaceGenerator(boolean requiresMatchedXMLGenerator) {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        String rootInterface ="com.viontech.base.BaseService<"+introspectedTable.getBaseRecordType()+">";
