...
import static org.mybatis.generator.internal.util.JavaBeansUtil.getImportJavaBeansSetter;
import static org.mybatis.generator.internal.util.JavaBeansUtil.getImportJavaBeansGetter;
	...
	public List<CompilationUnit> getCompilationUnits() {
		...
		// add by suman start
				for (IntrospectedColumn introspectedColumn : introspectedColumns) {
					...
					field.setType(importType);
					field.setName(getValidPropertyName(importType.getShortName()));
